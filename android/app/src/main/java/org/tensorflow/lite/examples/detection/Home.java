...
public class Home extends AppCompatActivity implements TextToSpeech.OnUtteranceCompletedListener {
        ...
        textToSpeech = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    textToSpeech.setOnUtteranceCompletedListener(Home.this);
                    if (firstTime == 0)
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                if (mVoiceInputTv.getText().toString().equals("exit")) {
                    ...
                    setContentView(R.layout.currencydetection);
                    textToSpeech.speak("Welcome to currency detection. Press long to return in main menu",TextToSpeech.QUEUE_FLUSH,null,"sss");
    ...
    public void onUtteranceCompleted(String s) {
        Intent i = new Intent(Home.this, CurrencyDetection.class);
        startActivity(i);
    }
}
