                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    timer = new CountDownTimer(3000,1000) {
                        ...
                        public void onTick(long l) {
                            Toast.makeText(getApplicationContext(), "returning to main menu "+ l/1000, Toast.LENGTH_SHORT).show();
    ...
    public void onResults(Bundle bundle) {
        ...
        if (phoneno.contains("0") || phoneno.contains("1") || phoneno.contains("2") || phoneno.contains("3") || phoneno.contains("4") || phoneno.contains("5")
            ...
            if(cursor.moveToFirst()) {
                ...
                if(a.get(abxc).contains(phoneno)){
                    n = a.get(abxc);
                    String[] d = n.split("@");
                    number = "Name is "+d[0] + " \n"+"Phone number is " + d[1];
                    phonenum = phoneno;
                    ...
                    phonenum = phoneno;
                    textToSpeech.speak("Phone Number is !!!! " + phoneno , TextToSpeech.QUEUE_FLUSH, null);
                    textToSpeech.speak("swipe left and, say yes to confirm or, Say No to talk back ", TextToSpeech.QUEUE_FLUSH, null);
