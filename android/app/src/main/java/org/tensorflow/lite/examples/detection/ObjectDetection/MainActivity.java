...
public class MainActivity extends CameraActivity implements OnImageAvailableListener, TextToSpeech.OnUtteranceCompletedListener {
        ...
        textToSpeech = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if(status!=TextToSpeech.ERROR){
                    ...
                    iscomplete = false;
                    textToSpeech.setOnUtteranceCompletedListener(MainActivity.this);
                     textToSpeech.speak("welcome to object detection. press long to return in main menu",TextToSpeech.QUEUE_FLUSH,null,"sss");
                 }
            }
        });
        ...
        runInBackground(() -> {
            if(iscomplete) {
                ...
                if (!results.isEmpty()) {
                    ...
                    textToSpeech.speak(title, TextToSpeech.QUEUE_FLUSH, null,"sss");
