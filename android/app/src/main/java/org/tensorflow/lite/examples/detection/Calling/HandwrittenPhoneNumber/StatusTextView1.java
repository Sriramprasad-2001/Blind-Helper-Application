            ...
            public void onInit(int i) {
                if (i != TextToSpeech.ERROR) {
                    ...
                    if(Size==10) {
                        ...
                        textToSpeech.speak(StrokeManager.getphoneno().toString()+ ", and name is "+finalname+ ", say yes to confirm ,or no to write the number again.", TextToSpeech.QUEUE_ADD,null,"hh");
                    }
                }
            }
        });
