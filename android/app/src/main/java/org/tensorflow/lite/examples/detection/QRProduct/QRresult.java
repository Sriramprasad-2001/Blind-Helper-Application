                ...
                x1 = touchEvent.getX();
                 timer = new CountDownTimer(3000,1000) {
                     ...
                     public void onFinish() {
                         Intent i = new Intent(QRresult.this, Home.class);
            ...
            if (requestCode == REQ_CODE_SPEECH_INPUT) {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (result.get(0).contains("no")) {
                        ...
                        textToSpeech.speak("swipe left to listen again or press long to return in main menu", TextToSpeech.QUEUE_ADD, null);
